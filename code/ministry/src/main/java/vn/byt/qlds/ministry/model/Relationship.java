...
public class Relationship {
    ...
    @Basic
    @Column(name = "relation_code", nullable = false, length = 10)
    ...
    @Basic
    @Column(name = "relation_name", nullable = false, length = 50)
    ...
    @Basic
    @Column(name = "relation_code_old", nullable = true, length = 10)
    public String getRelationCodeOld() {
        return relationCodeOld;
    }

    public void setRelationCodeOld(String relationCodeOld) {
        this.relationCodeOld = relationCodeOld;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id &&
                ...
                Objects.equals(relationCodeOld, that.relationCodeOld) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(relationCode, relationName, relationCodeOld, isDeleted, userCreated, userLastUpdated, timeCreated, timeLastUpdated, id);
    }
}
