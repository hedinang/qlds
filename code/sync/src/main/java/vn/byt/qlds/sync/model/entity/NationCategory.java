...
@Entity
@Table(name = "ethnic")
public class NationCategory implements Serializable {
    private int id;
    private String code;
    private String name;
    ...
    @Basic
    @Column(name = "is_minority", nullable = false)
    public boolean getIsMinority() {
        return isMinority;
    }

    public void setIsMinority(boolean minority) {
        isMinority = minority;
    }
    ...
    public boolean equals(Object o) {
        ...
        NationCategory that = (NationCategory) o;
        return id == that.id &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, notes, codeOld, isDeleted, userCreated, userLastUpdated, timeCreated, timeLastUpdated);
    }
}
