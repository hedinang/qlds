...
public class PersonHistory implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(changeId, regionId, personalId, dateUpdate, changeDate, changeTypeCode, source, destination, status, notes, userId, exportStatus, dieDate, goDate, comeDate, isDeleted, timeCreated, timeLastUpdated, userCreated, userLastUpdated);
    }
}
